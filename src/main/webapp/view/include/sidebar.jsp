    ...
    <div class="am-offcanvas-bar admin-offcanvas-bar">
        <ul class="am-list admin-sidebar-list">
            ...
            <li class="admin-parent">
                ...
                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                    <li><a href="${ctx}/infosetting/${userid}"> 个人设置</a></li>
                    <li><a href="${ctx}/system-setting/${userid}">系统设置</a></li>
                </ul>
            </li>
            <li><a href="${ctx}/log/${userid}?page=1"><span class="am-icon-inbox"></span> 系统日志<span class="am-badge am-badge-secondary am-margin-right am-fr">${lognumber }</span></a></li>
             <li class="admin-parent">
                <a class="am-cf" data-am-collapse="{target: '#collapse-nav1'}"><span class="am-icon-group"></span> 五子棋<span class="am-icon-angle-right am-fr am-margin-right"></span></a>
                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
                    <li><a href="${ctx}/AI_five-chess.jsp">人机对战</a></li>
                    <li><a href="${ctx}/createRoom.jsp">人人对战</a></li>
                </ul>
            </li>
        ...
        <div class="am-panel am-panel-default admin-sidebar-panel">
            <div class="am-panel-bd">
                <p><span class="am-icon-tag"></span> <strong>温馨提示</strong></p>
                <p>不要沉迷游戏哦</p>
            </div>
        </div>
    </div>
